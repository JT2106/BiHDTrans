...
def get_dataloader(train_dataset, val_dataset, test_dataset, args):
    ...
    train_dataset_tensor = TensorDataset(train_data_tensor, train_label_tensor)
    val_dataset_tensor = TensorDataset(val_data_tensor, val_label_tensor)
    test_dataset_tensor = TensorDataset(test_data_tensor, test_label_tensor)
...
def get_dataset(args):
    ...
    seq_len =  int(all_data.feature_df.shape[0] / all_data.labels_df.shape[0])

    return train_dataset, val_dataset, test_dataset, unique_labels, input_dim, seq_len
